import espaguete from "../src/img/espaguete.jpg";
import lasanha from "../src/img/lasanha.jpg";
import ravioli from "../src/img/ravioli.jpg";
import capeletti from "../src/img/capeletti.jpg";
import nhoque from "../src/img/nhoque.jpg";
import bruschetta from "../src/img/bruschetta.jpg";
import carpaccio from "../src/img/carpaccio.jpg";
import paella from "../src/img/paella.jpg";
import ebiSpicy from "../src/img/ebi-spicy.jpg";
import aligot from "../src/img/aligot.jpg";
import fileMignon from "../src/img/file-mignon.jpg";
import picanha from "../src/img/picanha.png";
import bifeAncho from "../src/img/bife-ancho.jpg";
import tomahwankSteak from "../src/img/tomahawk-steak.jpg";
import primeRib from "../src/img/prime-rib.jpg";
import tiramisu from "../src/img/tiramisu.jpg";
import cheesecake from "../src/img/cheesecake.jpg";
import banoffee from "../src/img/banoffee.png";
import milFolhas from "../src/img/mil-folhas.jpg";
import pudim from "../src/img/pudim.jpg";
import cerveja from "../src/img/cerveja.jpg";
import refrigerante from "../src/img/refrigerante.jpg";
import suco from "../src/img/suco.jpg";
import whiskey from "../src/img/whiskey.jpg";
import agua from "../src/img/agua.jpg";
import saladaCeasar from "../src/img/salada-ceasar.jpg";
import saladaCaprese from "../src/img/salada-caprese.jpg";
import saladaWaldorf from "../src/img/salada-waldorf.jpg";
import saladaGrega from "../src/img/salada-grega.jpg";
import saladaNicoise from "../src/img/salada-nicoise.jpg";
...
const produtos = [
  {
    ...
    preco: 20.0,
    descricao:
      "Um delicioso espaguete que pode ser combinado com diversos molhos, como bolonhesa, carbonara, alho e óleo e pesto.",
    imagem: espaguete,
  },
  {
    id: 2,
  ...
  },
  {
    ...
    preco: 8.99,
    descricao:
      "Massa feita de farinha de trigo e ovos, servida com molhos simples ou elaborados como, manteiga e parmesão, frango ao creme ou camarão alho e óleo.",
    imagem: nhoque,
  },
  {
    id: 6,
