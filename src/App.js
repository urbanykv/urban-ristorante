...
function App() {
  ...
  const [buscarItemCardapio, setBuscarItemCardapio] = useState();
    ...
    <div className="App">
      ...
      <main>
        <section className="busca-e-filtragem">
          ...
          <input type='text' id='buscaMenu' onChange={} placeholder='Pesquise aqui um dos pratos do nosso cardápio'/>
        </section>
